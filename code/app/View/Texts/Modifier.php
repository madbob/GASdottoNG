...
class Modifier
{
    ...
    private static function distributionLabels()
    {
        ...
        return [
			...
			'mass,product,absolute' => [_i("per ogni Kg, somma al costo del prodotto"), $currency],
            'mass,booking,absolute' => [_i("per ogni Kg, somma al costo della prenotazione"), $currency],
            'mass,order,absolute' => [_i("per ogni Kg, somma al costo dell'ordine"), $currency],
            'mass,product,percentage' => [_i("per ogni Kg, somma al costo del prodotto"), '%'],
            'mass,booking,percentage' => [_i("per ogni Kg, somma al costo della prenotazione"), '%'],
            'mass,order,percentage' => [_i("per ogni Kg, somma al costo dell'ordine"), '%'],
