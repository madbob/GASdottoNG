...
return array(
    'aggregations' => array(
        ...
        'help' => array(
            'limit_access_to_order' => 'Wenn Elemente ausgewählt sind, ist die Bestellung nur für Leute sichtbar, die in den entsprechenden Gruppen sind. Wenn kein Element ausgewählt ist, ist die Bestellung für alle sichtbar.',
            'permit_selection' => 'Durch Auswahl eines oder mehrerer Elemente können Benutzer*innen eines davon bei der Bestellung auswählen.',
            'context' => '',
            'limit_access' => '',
            'no_user_aggregations' => 'Es gibt noch keine Gruppierungen, die den Benutzer*innen zugeordnet werden können.',
        ),
        'permit_selection' => 'Auswahl zulassen',
        'context' => '',
        'by_booking' => '',
        'cardinality' => '',
        'cardinality_one' => 'eine einzelne Gruppe',
        'cardinality_many' => 'mehrere Gruppen',
        'user_selectable' => 'Auswahl der Benutzer*in',
        'group' => 'Gruppe',
    ...
    'auth' => array(
        'accept_privacy' => 'Ich habe die <a href=":link" target="_blank">Datenschutzhinweise</a> gelesen und akzeptiere sie.',
        ...
        'help' => array(
            ...
            'username_same_password' => 'Das Passwort ist identisch mit dem Benutzernamen! Ändere es, sobald wie möglich, in deinem <a class="ms-1" href=":link">Nutzerprofil</a>!',
        ...
        'failed' => 'Eingabe nicht korrekt.',
        'throttle' => 'Zu viele Zugriffsversuche. Versuchen Sie es in :seconds Sekunden erneut.',
        'access' => 'Zugriff',
        'wrong' => 'Passwort falsch!',
        'enforce_change' => 'Passwort beim nächsten Login ändern',
    ),
    'commons' => array(
        'accept_conditions' => 'Ich habe die <a href=":link" target="_blank">Nutzungsbedingungen</a> gelesen und akzeptiere sie.',
        'warning' => 'Achtung',
        'loading' => 'Ladevorgang',
        'feedback' => 'Rückmeldung',
        'about' => array(
            'opensource' => 'GASdotto wird als Open-Source-Projekt entwickelt!',
            'contribute' => 'Du kannst untesrstützen, indem du eine Nachricht oder Anfrage schickst:',
            'donate' => 'Oder gib eine Spende:',
    ...
    'export' => array(
        'help' => array(
            ...
            'importing' => array(
                ...
                'user' => array(
                    ...
                    'balance' => 'Achtung! Verwende Dieses Attribut nur beim ersten Import von Benutzer*innen und nur für neue Benutzer*innen, ansonsten sind die Kontostände falsch!',
            ...
            'img_csv_instructions' => 'Erklärung zur CSV-Formatierung',
        ),
        'importing' => array(
            'deliveries' => array(
                'first_product' => 'Erstes Produkt',
                'instruction' => 'Hier kannst du eine CSV-Datei, die von der Funktion "Gesamttabelle der Produkte" generiert wurde, wieder importieren, nachdem die gelieferten Mengen für jede bestellende Person aktualisiert wurden.',
                'notice' => 'Bitte beachten: Wie bei normalen Lieferungen wird davon ausgegangen, dass die gelieferte Menge der Stückwaren hier nach Gewicht und nicht nach Stückzahl angegeben wird.',
                'product_error' => 'Nicht identifiziertes Produkt: :name',
                'order_error' => 'Nicht identifizierte Bestellung',
                'done' => 'Importierte Lieferungen',
            ),
        ),
        'balance_csv_filename' => 'Export der Bilanz :date.csv',
        ...
        'data' => array(
            ...
            'split_friends' => 'Freunde, aufgeteilt',
        ),
        'export' => array(
            'database' => 'Exportieren',
        ),
        'help_split_friends' => 'Standardmäßig werden die Reservierungen von "Freunden" mit denen der jeweiligen Hauptnutzer*in zusammengefasst. Wenn "Ja" ausgewählt ist, werden sie im Dokument als eigenständige Reservierungen dargestellt.',
        'help_aggregate_export_summary' => 'Hier kannst du ein Dokument abrufen, das die vorbestellten Mengen aller Produkte zusammenfasst: nützlich, um es nach Abschluss der Bestellung an den Lieferanten zu senden.',
        'flags' => array(
            'include_unbooked' => 'Nicht vorbestellte Produkte inkludieren',
        ),
        'do_balance' => 'Bilanz exportieren',
        'movements_heading' => 'Export der Gasdotto-Bewegungen zum :date',
        'accepted_columns' => 'Die für diesen CSV-Typ zulässigen Spalten sind:',
    ),
    'gas' => array(
        'help' => array(
            'csv_separator' => 'Das Zeichen, das zur Trennung der Felder in allen exportierten CSV-Dateien verwendet werden soll. Die Wahl dieses Werts hängt vor allem von der Anwendung ab, mit der diese Dateien geöffnet werden. Wir empfehlen die Verwendung von <a target=\'_blank\' href=\'http://de.libreoffice.org/\'>LibreOffice</a>.',
            ...
            'default_columns_shipping_split_friends' => '',
            ...
            'manual_products_sorting' => 'Durch Aktivieren dieser Option kann im Schnellbearbeitungsfeld der Lieferantenprodukte eine beliebige Sortierung erzeugt werden',
            ...
            'automatic_fees' => 'Wenn diese Option aktiviert ist, werden die Beiträge aller aktiven Mitglieder am Ende des Mitgliedsjahres automatisch aktualisiert und direkt mit dem Konto verrechnet.',
            'enable_sepa' => 'Durch das Ausfüllen dieser Felder wird der Export von SEPA-Dateien freigeschaltet, mit dem Überweisungen automatisiert werden können. Die Dateien werden über Buchhaltung -> Kreditstatus -> SEPA exportieren erzeugt. Nachdem dieses Formular ausgefüllt wurde, müssen für jede*n Benutzer*in einige Parameter im Profil ausgefüllt werden',
            ...
            'enabled_satispay' => '',
            'satispay_activation_code' => 'Sie können den Aktivierungscode in ihrem Satispay-Dashboard erhalten',
            'enable_integralces' => '',
            ...
            'multigas_mode' => '',
            'only_bookings_with_credit_limit' => 'Nutzer*innen können keine neuen Produkte vorbestellen, wenn ihr Guthaben unter diesen Schwellenwert fällt',
            'fast_product_change_columns' => 'Spalten die im Schnellbearbeitungsraster für Produkte standardmäßig angezeigt werden',
        ),
        ...
        'enable_deliveries_no_quantities' => 'Manuelle Lieferungen ohne Mengenangaben zulassen',
        'display_contacts' => 'Kontakte in Buchungen anzeigen',
        ...
        'manual_products_sorting' => 'Manuelle Umsortierung der Produktliste erlauben',
        'fast_product_change_columns' => 'Schnelle Änderung',
        'social_year' => 'Jahresbeginn',
        'automatic_fees' => 'Automatische Abrechnung der Beiträge am Ende des Mitgliedsjahres',
        ...
        'enable_hub' => '',
        'csv_separator' => 'CSV-Datei-Trennzeichen exportiert',
        'import' => 'Import',
        'multigas_mode' => '',
        'only_bookings_with_credit_limit' => 'Kreditlimit',
        'enabled_fields' => 'Aktivierte Felder',
    ),
    'generic' => array(
        'save' => 'Speichern',
        ...
        'help' => array(
            ...
            'unchange_password' => 'Freilassen um das Passwort nicht zu ändern',
        ...
        'attachments' => array(
            ...
            'replace_url' => 'URL ersetzen',
            'large_file' => 'Die Datei ist zu groß!',
        ),
        ...
        'updated_at' => 'Ändern',
        'multigas_name' => 'Name der neuen Bestellgemeinschaft',
        ...
        'current_gas_name' => 'Aktives Gasdotto: :label',
    ...
    'imports' => array(
        'help' => array(
            ...
            'no_currency_found' => 'Währung nicht gefunden: :name',
            ...
            'remote_index' => 'Diese Funktion ermöglicht den Zugriff auf gemeinsam genutzte Preislisten unter :url und deren automatische Aktualisierung. Achtung: Es handelt sich um eine experimentelle Funktion, bitte mit Vorsicht verwenden!',
        ),
...
%[gas_login_link]',
            ...
            'description' => 'Nachricht an genehmigte Mitglieder gesendet.',
...
%[gas_login_link]',
        ...
        'newuser' => array(
            'description_manual' => 'Nachricht, die an neue Mitglieder gesendet wird, die sich auf der Plattform registriert haben und auf ihre Freigabe warten.',
    ...
    'movements' => array(
        ...
        'credit' => 'Kontostand',
        'defaults' => array(
            'fee' => 'Zahlung des Jahresbeitrags durch ein Mitglied',
            'booking' => 'Zahlung der Vorbestellung durch ein Mitglied',
            'booking_adjust' => 'Anpassung der Zahlung für eine Vorbestellung durch ein Mitglied',
            'deposit' => 'Kaution für Mitglieder',
            'deposit_return' => 'Rückerstattung der Kaution von Mitgliedern',
            'donation_from' => '',
            'donation' => '',
            'expense' => '',
            'put' => '',
            'invoice' => 'Rechnung an Lieferanten bezahlen',
            'order' => 'Bestellung an Lieferanten bezahlen',
            'rounding' => '',
            'credit' => '',
            'decredit' => '',
            'refund' => '',
        ...
        'help' => array(
            ...
            'paying' => 'Die Art der Einheit, welche die Zahlung ausführt. Wenn diese Option ausgewählt ist, kann die Einheit innerhalb der Eingabemaske für die Erstellung neuer Zahlungsbewegungstypen ausgewählt und spezifiziert werden',
            'payed' => 'Die Art der Einheit, welche die Zahlung empfängt. Wenn diese Option ausgewählt ist, kann die Einheit innerhalb der Eingabemaske für die Erstellung neuer Zahlungsbewegungstypen ausgewählt und spezifiziert werden',
            'system_type_notice' => '',
    ...
    'orders' => array(
        'booking' => array(
            ...
            'statuses' => array(
                ...
                'shipped' => 'Geliefert',
                'paying' => 'Bezahlungsstatus der Nutzer*innen',
                'archived' => 'Archiviert',
        ...
        'help' => array(
            ...
            'contacts_notice' => 'Für Meldungen zu dieser Bestellung wende dich bitte an:',
            ...
            'aggregation_instructions' => 'Klick und nimm die Bestellungen in der gleiche Zelle um sie zusammen zu stellen, oder in eine leere Zelle um sie zu trennen.',
            ...
            'prices_changed' => 'Die Preise einiger Produkte haben sich seit der Bestellung geändert. Unten kannst du auswählen, welcher Preis im Falle einer Lieferkorrektur gelten soll: der ursprünglich angegebene Preis oder der aktuelle Listenpreis.',
            'variant_no_longer_active' => 'Bitte beachten: Die bei der Buchung ausgewählte Variante ist nicht mehr in der Preisliste enthalten',
            'pending_saved_bookings' => '',
            'mail_order_notification' => '',
            'target_supplier_notifications' => '',
            'notify_only_partecipants' => '',
            'comment' => 'Eventueller Informationstext, der im Titel der Bestellung angezeigt werden soll. Wenn er länger als :limit Zeichen ist, wird der Text stattdessen in das Fenster der entsprechenden Reservierungen aufgenommen.',
            ...
            'unremovable_notice' => '',
            'void_booking' => 'Möchtest du diese Vorbestellung wirklich stornieren?',
        ),
        ...
        'documents' => array(
            'shipping' => array(
                ...
                'short_heading' => 'Details zur Lieferung vom :date',
            ),
            'summary' => array(
    ...
    'products' => array(
        ...
        'help' => array(
            ...
            'package_size' => 'Wenn das Produkt in Abpackungen von n Stücken ausgegeben wird, wird hier der Wert von n angezeigt. Die Bestellungen an den Lieferanten müssen die Anzahl der Verpackungen enthalten, d.h. die Anzahl der bestellten Stücke / die Anzahl der Stücke in der Verpackung. Wenn die Gesamtmenge der bestellten Stücke nicht ein Vielfaches dieser Anzahl ist, ist das Produkt in der Tabelle, welche die Zusammenfassung der bestellten Produkte enthält, mit einem roten icon gekennzeichnet. Aus dieser Tabelle lassen sich die Mengen systematisieren, indem - wo erforderlich - hinzugefügt und weggenommen wird.',
