...
return array(
    ...
    'auth' => array(
        ...
        'enforce_change' => 'Force password change on next login',
    ...
    'gas' => array(
        'help' => array(
            ...
            'default_columns_shipping_split_friends' => 'To determine whether friends should be kept separate or not, by default',
        ),
    ...
    'notifications' => array(
        ...
        'help' => array(
            ...
            'types' => 'Normal notifications have a start and end date, within which they are displayed on the dashboard of the recipient users (who can also dismiss them independently).<br>Persistent notifications, on the other hand, remain on the dashboard of the recipient users indefinitely and can only be removed by administrators.<br>Calendar dates appear in the dashboard calendar and serve as reminders of events that do not necessarily involve orders and reservations (e.g., assemblies, meetings, meetings, other appointments, etc.).',
        ),
        'cycle' => array(
    ...
    'orders' => array(
        ...
        'help' => array(
            ...
            'booked_disabled_product' => 'There are active reservations for this product. Are you sure you want to disable it?',
            'booking_already_exists' => 'This booking already exists and cannot be recreated.',
        ...
        'constraints' => array(
            ...
            'completing_max' => 'Quantity exceeding the maximum orderable to complete the package',
            'completing_max_formatted' => 'There are still :still :measure missing to complete the package for this order',
            'completing_max_short' => ':icon Available: :quantity',
        ),
        'documents' => array(
            'shipping' => array(
        ...
        'files' => array(
            ...
            'booking' => array(
                'shipping' => 'Booking Details',
            ),
            'public' => array(
                'help' => 'From here you can download the files related to the order<br>:order',
            ),
        ),
    ...
    'permissions' => array(
        ...
        'revoke_confirm' => 'Do you really want to revoke this role?',
    ),
    'products' => array(
        'prices' => array(
            'unit' => 'Unit price',
