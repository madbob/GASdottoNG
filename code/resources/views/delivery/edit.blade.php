                        ...
                        @foreach($o->products as $product)
                            @if($product->variants->isEmpty() == true)
                                <tr class="booking-product">
                                    ...
                                    <td>
                                        <label class="static-label booking-product-booked">{{ printableQuantity($product->quantity) }} {{ $product->product->printableMeasure(true) }}</label>
                                    </td>
                            ...
                            @else
                                ...
                                @foreach($product->variants as $var)
                                    ...
                                    <tr class="booking-product">
                                        ...
                                        <td>
                                            <label class="static-label booking-product-booked">{{ printableQuantity($var->quantity) }} {{ $product->product->printableMeasure(true) }}</label>
                                        </td>
