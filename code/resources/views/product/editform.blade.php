...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <x-larastrap::decimal name="multiple" :label="_i('Multiplo')" decimals="3" :pophelp="_i('Se diverso da 0, il prodotto è prenotabile solo per multipli di questo valore. Utile per prodotti pre-confezionati ma prenotabili individualmente. Da non confondere con l\'attributo Confezione')" />
