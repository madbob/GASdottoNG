                    ...
                    <x-larastrap::accordionitem :label="_i('Contabilità')">
                        <x-larastrap::form :obj="$gas" classes="inner-form gas-editor" method="PUT" :action="route('gas.update', $gas->id)">
                            <div class="row">
                                ...
                                <div class="col">
                                    <x-larastrap::text name="year_closing" :label="_i('Inizio Anno Sociale')" classes="date-to-month" textappend="<i class='bi-calendar'></i>" :pophelp="_i('In questa data le quote di iscrizione verranno automaticamente fatte scadere e dovranno essere rinnovate')" />
                                    ...
                                    <div class="collapse {{ $gas->hasFeature('extra_invoicing') ? 'show' : '' }}" data-triggerable="enable_extra_invoicing">
                                        <div class="col-md-12">
                                            <div class="well">
                                                ...
                                                <x-larastrap::text name="extra_invoicing->taxcode" :label="_i('Codice Fiscale')" :value="$gas->extra_invoicing['taxcode']" />
                                                <x-larastrap::text name="extra_invoicing->vat" :label="_i('Partita IVA')" :value="$gas->extra_invoicing['vat']" />
