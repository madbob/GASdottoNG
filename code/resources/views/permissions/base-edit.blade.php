...
<x-larastrap::select-model name="parent_id" :label="_i('Ruolo Superiore')" :options="allRoles()" :extra_options="[0 => _i('Nessuno')]" :pophelp="_i('Gli utenti con assegnato il ruolo superiore potranno assegnare ad altri utenti questo ruolo')" />
