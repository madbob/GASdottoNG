...
@if(isset($dynamic_url))
    <div class="modal fade dynamic-contents close-on-submit" id="create{{ ucfirst($typename) }}" tabindex="-1" role="dialog" aria-labelledby="create{{ ucfirst($typename) }}" data-contents-url="{{ $dynamic_url }}">
