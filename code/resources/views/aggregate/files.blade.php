<div class="list-group">
	...
	<x-larastrap::ambutton classes="list-group-item" :label="_i('Tabella Complessiva Aggregato')" :data-modal-url="route('aggregates.export', ['id' => $aggregate->id, 'type' => 'table', 'managed_gas' => $managed_gas])" />
</div>
