<form class="form-horizontal main-form" method="PUT" action="{{ url('users/' . $user->id) }}">
	<div class="row">
		<div class="col-md-6">
			@include('commons.staticstringfield', ['obj' => $user, 'name' => 'name', 'label' => 'Nome', 'mandatory' => true])
			@include('commons.staticstringfield', ['obj' => $user, 'name' => 'surname', 'label' => 'Cognome', 'mandatory' => true])
