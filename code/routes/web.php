...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['commonuser'])->group(function () {
        ...
        Route::get('orders/advanced/{id}', 'OrdersController@advanced')->name('orders.advanced');
        Route::post('orders/duplicate/{id}', 'OrdersController@duplicate')->name('orders.duplicate');
        ...
        Route::put('booking/{aggregate_id}/user/{user_id}/dynamics', 'BookingUserController@dynamicModifiers')->name('booking.dynamics');
